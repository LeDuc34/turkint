...
const Header = () => {
  ...
  <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
    ...
    <div id="collapseMenu"
      ...
      <button id="toggleClose" className='lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white p-3' onClick={btnSubmit}>
      ...
      <ul
        ...
        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
          <a href="/dashboard/ordersInterface"
            className='hover:text-red-800 text-black block font-semibold text-[15px]'>Commandes</a>
        </li>
        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='/dashboard/usersList'
            className='hover:text-red-800 text-black block font-semibold text-[15px]'>Utilisateurs</a>
        </li>
        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='/dashboard/analytics'
            className='hover:text-red-800 text-black block font-semibold text-[15px]'>Statistiques</a>
        </li>
      </ul>
    </div>
