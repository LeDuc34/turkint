...
const Header = () => {
  ...
  <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
    ...
    <div id="collapseMenu"
      ...
      <ul
        ...
        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
          <a href="/"
            className='hover:text-black text-white block font-semibold text-[15px]'>Commander</a>
        </li>
        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='/myprofile'
            className='hover:text-black text-white block font-semibold text-[15px]'>Mon profil</a>
        </li>
        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='/basket'
            className='hover:text-black text-white block font-semibold text-[15px]'>Mon panier</a>
        </li>
        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='/presentation'
            className='hover:text-black text-white block font-semibold text-[15px]'>Turk'int</a>
        </li>
      </ul>
    </div>
    ...
    <div className='flex max-lg:ml-auto space-x-3'>
      <button
        className='px-4 py-2 text-sm rounded-full font-bold text-white border-2 border-black bg-red-800 transition-all ease-in-out duration-300 hover:bg-transparent hover:text-black' onClick={btnSubmit}>Se connecter</button>
